...
export default function AdminSideBar({ active }) {
  ...
  return (
    <div
      className="bg-white mr-5 py-3 px-4 h-fit"
      style={{
        width: "265px",
      }}
    >
      {items.map((item, index) => (
        <div
          ...
          className={
            active == index
              ? "flex text-base items-center cursor-pointer bg-hover px-5 py-3 mt-4 text-white"
              : "flex items-center text-base cursor-pointer px-5 py-3 mt-4"
          }
          style={{
        ...
        >
          <img
            src={active === index ? item.iconActive : item.icon}
            alt=""
